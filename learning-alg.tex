...
but which must anyway be present since its input is a timeout event for
 ...
 During {\bf hypothesis construction}, membership queries are performed in order
...
\begin{itemize}
\item Membership queries are performed
...
\item
 \todobj{I now got as far as this}
  Membership queries are performed
