...
\newcommand{\toinputs}[1]{\hat{I}_{#1}}
\newcommand{\extinputs}{\toinputs{X}}
\newcommand{\extextinputs}{\tilde{I}}
...
\newcommand{\untimebeh}{\mathit{utbeh}}
\newcommand{\run}{\mathit{pullback}}
\newcommand{\mmtpath}{\tau}
\newcommand{\mmtpathof}[1]{\tau_{#1}}
\newcommand{\timedword}{\mathit{tw}}
\newcommand{\twsof}[1]{\mathit{TW}(#1)}
...
\newcommand{\fcan}[1]{\mathit{fcan}({#1})}
\newcommand{\cani}{\hat{i}}
\newcommand{\lean}[1]{\mathit{lean}({#1})}
\newcommand{\uncan}[1]{\mathit{uncan}({#1})}
\newcommand{\canmap}[2]{h_{#2}^{#1}}
\newcommand{\invcanmap}[2]{(h_{#2}^{#1})^{-1}}
\newcommand{\timerlive}[2]{\mbox{\it tl}_{#1}({#2})}
\newcommand{\timerlivebehs}[1]{\mbox{\it timer-live}({#1})}
...
\newcommand{\saturatebeh}[2]{[#1]_{#2}}
\newcommand{\saturateset}[1]{[#1]}
...
\newcommand{\sdelay}[1]{\ \rightarrow_{#1} \ }
\newcommand{\rtcsdelay}[1]{\ {\rightarrow_{#1}}^*\ }
\newcommand{\wdelay}[1]{\ \Rightarrow_{#1}\ }
\newcommand{\rtcwdelay}[1]{\ {\Rightarrow_{#1}}^*\ }
\newcommand{\rtcswdelay}[1]{\ {(\rightarrow_{#1} \cup \Rightarrow_{#1})}^*\ }
...
\newcommand{\notiff}{\centernot\iff}
\newcommand{\smallnotiff}{\centernot\smalliff}

%% macros for ``algorithm''
\newcommand{\Constraints}[1]{\Phi_{#1}}
\newcommand{\Constraintsrf}[1]{\mathsf{constraints}^{\mathit{rf}}({#1})}
\newcommand{\Frac}[1]{\mathsf{frac}({#1})}
\newcommand{\Addtimer}[4]{\mathsf{addtimer}[{#1,#2,#3}]({#4})}
\newcommand{\Addtimerop}[3]{\mathsf{addtimer}[{#1,#2,#3}]}
