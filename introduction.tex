...
We omit trivial self-loops: if some state $q$ does not have an outgoing $i$-transition
then implicitly there is a self-loop with output $\Lambda$.
\iflong
Here $\Lambda$ denotes the absence of an observable output. 
