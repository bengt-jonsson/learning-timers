...
\title[Automata Learning and Galois Connections]{%
...
\date[]{ICALP'19, Patras, Greece, July 2019}
...
\frame{
	\frametitle{A Common Problem for Software Engineers}
...
\section{Active Learning Using Mappers}
...
\begin{center}
\includegraphics[width=\textwidth]{benchmarks.jpg}
\end{center}
}
