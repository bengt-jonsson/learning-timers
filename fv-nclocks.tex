...
The scenario of Figure~\ref{fig:races} is similar to the well-known Rush Hour puzzle game,
...
%
Since emptiness of DBMs is decidable, the following lemma allows us to compute whether or not an untimed behavior is feasible.
...
%
We will show how an untimed learner for MMTs can be implemented using an timed teacher for MMTs,
...
The learner initially only knows the set $I$ of inputs of $\M$, and may pose
...
Initially, the timed learner only knows the set $I$ of input of $\M$.
